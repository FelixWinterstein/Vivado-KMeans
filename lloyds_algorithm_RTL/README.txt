...
9) All important design parameters are set in the files 'source/vhdl/lloyds_algorithm_pkg.vhd'.
...
Before running the simulation modify line 27 and 28 of 'testbench.vhd' according to which files you want to use.
